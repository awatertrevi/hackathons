...
namespace FlexWork.iOS.CustomRenderers
{
	public class ExtendedMapRenderer : MapRenderer
	{
		...
		protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
		{
			...
			else if (e.PropertyName == "RouteCoordinates")
			{
				//render
				...
				{
					var line = nativeMap.Overlays.FirstOrDefault();
					if (line != null)
						nativeMap.RemoveOverlay(line);
				}
		...
		MKOverlayRenderer GetOverlayRenderer(MKMapView mapView, IMKOverlay overlay)
		{
			if (overlay is MKPolyline)
			{
				...
				{
					if (overlay.GetType().Name == "MKOverlayWrapper")
						overlay = Runtime.GetNSObject(overlay.Handle) as IMKOverlay;
		...
		private void ExtendedMapRenderer_DidSelectAnnotationView(object sender, MKAnnotationViewEventArgs e)
		{
			...
			if (elementPin != null)
			{
				...
				System.Diagnostics.Debug.WriteLine("showThing");
				((MKMapView)this.Control).DeselectAnnotation(e.View.Annotation, false);
			}
		}
