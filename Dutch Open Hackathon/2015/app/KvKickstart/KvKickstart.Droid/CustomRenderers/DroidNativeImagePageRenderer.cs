...
[assembly: ExportRenderer (typeof(DOH2015.IndoorsPage), 
	typeof(DOH2015.Droid.DroidNativeImagePageRenderer))]
namespace DOH2015.Droid
{
	public class DroidNativeImagePageRenderer : PageRenderer
	{
		ScaleImageView _view;

		public DroidNativeImagePageRenderer ()
		{
		}
		...
		protected override void OnElementChanged (ElementChangedEventArgs<Page> e)
		{
			...
			var FormsPage = e.NewElement as IndoorsPage;

			DisplayMetrics dm = Context.Resources.DisplayMetrics;

			var options = new Android.Graphics.BitmapFactory.Options ();
			options.InDensity = (int)dm.DensityDpi;
			options.InScreenDensity = (int)dm.DensityDpi;
			options.InTargetDensity = (int)dm.DensityDpi;      
			Bitmap bmp = BitmapFactory.DecodeResource (Resources, Resource.Drawable.indoorsmap);
			//Bitmap bmp = BitmapFactory.DecodeStream (FormsPage.ImageStream);
			_view = new ScaleImageView (this.Context, null);
			_view.SetImageBitmap (bmp);
 ...
 */
	...
	public class ScaleImageView : ImageView, Android.Views.View.IOnTouchListener
	{
